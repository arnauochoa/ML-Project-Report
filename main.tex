...
%%% PERFORMANCE: analysis of j cost plot and add: The most common practice when implementing the algorithm is to try different values of $\alpha$ in order to see which results in a better performance. 


%%%%Feature scaling must be added??? or is already explained in data analysis
